  ...
  return (
    <>
      <div className="relative w-full min-h-screen overflow-hidden bg-[#ede0d4]">
        ...
        <div
          className="absolute top-18 left-1/2 transform -translate-x-1/2 z-20 whitespace-nowrap"
      ...
      <div className="h-[100vh] bg-[#7f5539]/50 relative">
        ...
        <div ref={coffeeSectionRef} className="absolute w-full md:w-[50%] h-[100vh] bg-white/20 flex flex-col gap-5 left-0 top-0 p-4 md:p-10 opacity-0">
          <h1 ref={coffeeTitleRef} className="text-white titillium-web-regular mt-20 text-xl md:text-3xl ml-4 md:ml-10">
            PUREST ARABICA COFFEE BEANS
          </h1>
          <p ref={coffeeTextRef} className="text-sm md:text-md text-white/90 w-full md:w-[75%] font-mono tracking-wide ml-4 md:ml-10">
