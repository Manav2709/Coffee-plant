...
const NavBar = () => {
  ...
  return (
    <nav ref={navRef} className="absolute top-5 left-1/2 transform -translate-x-1/2 w-[95%] md:w-[80%] bg-[#b08968]/50 rounded-lg backdrop-blur-3xl z-40 px-4 p-1 flex items-center justify-between">
